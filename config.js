...
const CONFIG = {
    ...
    questions: {
        first: {
            ...
            secretAnswer: "Ты мне не просто нравишься, я тебя люблю❤️"           // Secret hover message
        },
        second: {
    ...
    celebration: {
        ...
        message: "А теперь иди сюда, получи свой подарок, крепкие теплые объятия и сладкий поцелуй!Моя вип писька💙💚",
